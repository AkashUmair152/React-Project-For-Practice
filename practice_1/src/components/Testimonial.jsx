      ...
      <div className="max-w-6xl mx-8 md:mx-10 lg:mx-20 xl:mx-auto">
        <div className="transition duration-500 ease-in-out transform scale-100 translate-x-0 translate-y-0 opacity-100">
          <div className=" space-y-5 md:mb-16 md:text-center">
            <div className="inline-block px-3 py-1 text-md font-semibold rounded-lg md:text-center text-cn  bg-opacity-60 hover:cursor-pointer hover:bg-opacity-40 text-green-800 ">
              TESTIMONIALS
            </div>
            <h1 className="mb-5 text-3xl font-semibold md:text-center md:text-5xl text-green-800">
              What Clients Say
            </h1>
          ...
          <ul className="space-y-8">
            <li className="text-sm leading-6">
              <div className="relative group">
                <div className="absolute transition rounded-lg opacity-25 -inset-1 bg-gradient-to-r from-green-600 to-green-200 blur duration-400 group-hover:opacity-100 group-hover:duration-200"></div>
                <a
