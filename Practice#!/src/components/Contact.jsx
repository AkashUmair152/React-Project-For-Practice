...
const Contact = () => {
  return (
    <div className="w-[85%] my-12 mx-auto px-2 md:px-4">
      <section className="mb-32">
        <div className="flex justify-center">
          <div className="text-center md:max-w-xl lg:max-w-3xl">
            <h2 className="mb-12 px-6 text-3xl text-green-700 font-bold">
              Contact us
            </h2>
          </div>
        </div>
        ...
        <div className="flex flex-wrap">
          <form className="mb-12 w-full shrink-0 grow-0 basis-auto md:px-3 lg:mb-0 lg:w-5/12 lg:px-6">
            ...
            <button
              type="button"
              className="mb-6 inline-block w-full rounded bg-green-600 px-6 py-2.5 font-medium uppercase leading-normal text-white hover:shadow-md hover:bg-green-700"
            >
              Send
            </button>
          </form>
              ...
              <div className="mb-12 w-full shrink-0 grow-0 basis-auto md:w-6/12 md:px-3 lg:px-6">
                <div className="flex items-start">
                  <div className="shrink-0">
                    <div className="inline-block rounded-md bg-teal-400-100 p-4 text-green-700">
                      <svg
